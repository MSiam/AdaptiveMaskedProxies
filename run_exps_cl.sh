python cl_naive.py --config configs/fcn8s_pascal_cl.yml --model_path runs/ipascal_reduced/reduced_fcn8s_ipascal_best_model.pkl --cl_log cl_results/1cl_naive.txt --niters 1
python cl_naive.py --config configs/fcn8s_pascal_cl.yml --model_path runs/ipascal_reduced/reduced_fcn8s_ipascal_best_model.pkl --cl_log cl_results/2cl_naive.txt --niters 10

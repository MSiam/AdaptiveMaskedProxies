...
do
    ...
    python fewshot_imprinted.py --config configs/redfcn8s_pascal_imprinted.yml --model_path runs/reddilatedfcn8s_pascal/reduced_fcn_fold$fold/dilated_fcn8s_pascal_best_model.pkl --binary 2 --fold $fold >> logs_1shot/out$fold.txt

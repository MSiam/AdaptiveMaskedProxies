...
do
    ...
    python fewshot_imprinted.py --config configs/redfcn8s_pascal_imprinted_5shot.yml --model_path runs/reddilatedfcn8s_pascal/dilated_fcn_fold$fold/dilated_fcn8s_pascal_best_model.pkl --binary 1 --fold $fold >> logs_5shot/out$fold.txt
    python fewshot_imprinted.py --config configs/redfcn8s_pascal_imprinted_5shot.yml --model_path runs/reddilatedfcn8s_pascal/dilated_fcn_fold$fold/dilated_fcn8s_pascal_best_model.pkl --binary 2 --fold $fold >> logs_5shot_fgbg/out$fold.txt
